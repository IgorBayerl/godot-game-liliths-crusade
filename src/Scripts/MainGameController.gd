...
func _ready() -> void:
	...
	gun_mira = $LevelLoader/Main/Player2.gun_mira
	gunsProps = $LevelLoader/Main/Player2.gunsProps
	gunsSprite = $LevelLoader/Main/Player2.gunsSprite
	Player = $LevelLoader/Main/Player2
	_update_gun()
